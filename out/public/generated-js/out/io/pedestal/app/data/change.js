...
var vec__10227 = (((cljs.core.count.call(null,path_a) < cljs.core.count.call(null,path_b)))?cljs.core.PersistentVector.fromArray([path_a,path_b], true):cljs.core.PersistentVector.fromArray([path_b,path_a], true));
var small = cljs.core.nth.call(null,vec__10227,0,null);
var large = cljs.core.nth.call(null,vec__10227,1,null);
return cljs.core._EQ_.call(null,small,cljs.core.take.call(null,cljs.core.count.call(null,small),large));
});
io.pedestal.app.data.change.remove_redundant_updates = (function remove_redundant_updates(updates){
return cljs.core.reduce.call(null,(function (a,update){
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__10228_SHARP_){
return io.pedestal.app.data.change.descendent_QMARK_.call(null,p1__10228_SHARP_,update);
}),a)))
{return a;
} else
...
io.pedestal.app.data.change.remove_redundant_adds = (function remove_redundant_adds(adds){
return cljs.core.reduce.call(null,(function (a,add){
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__10229_SHARP_){
return io.pedestal.app.data.change.descendent_QMARK_.call(null,p1__10229_SHARP_,add);
}),a)))
{return a;
} else
...
io.pedestal.app.data.change.compact = (function compact(old_m,new_m,p__10230){
var map__10234 = p__10230;
var map__10234__$1 = ((cljs.core.seq_QMARK_.call(null,map__10234))?cljs.core.apply.call(null,cljs.core.hash_map,map__10234):map__10234);
var change = map__10234__$1;
var inspect = cljs.core.get.call(null,map__10234__$1,"\uFDD0:inspect");
var removed = cljs.core.get.call(null,map__10234__$1,"\uFDD0:removed");
var updated = cljs.core.get.call(null,map__10234__$1,"\uFDD0:updated");
var added = cljs.core.get.call(null,map__10234__$1,"\uFDD0:added");
...
var change__$2 = (cljs.core.truth_((new cljs.core.Keyword("\uFDD0:updated")).call(null,change__$1))?cljs.core.update_in.call(null,change__$1,cljs.core.PersistentVector.fromArray(["\uFDD0:updated"], true),io.pedestal.app.data.change.remove_redundant_updates):change__$1);
var change__$3 = (cljs.core.truth_((new cljs.core.Keyword("\uFDD0:added")).call(null,change__$2))?cljs.core.update_in.call(null,change__$2,cljs.core.PersistentVector.fromArray(["\uFDD0:added"], true),io.pedestal.app.data.change.remove_redundant_adds):change__$2);
...
return cljs.core.reduce.call(null,(function (a,p__10235){
var vec__10236 = p__10235;
var k = cljs.core.nth.call(null,vec__10236,0,null);
var v = cljs.core.nth.call(null,vec__10236,1,null);
