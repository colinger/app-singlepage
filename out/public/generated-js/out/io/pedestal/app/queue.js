...
return cljs.core.update_in.call(null,cljs.core.assoc.call(null,queue_state,"\uFDD0:item",cljs.core.first.call(null,priority.call(null,queues))),cljs.core.PersistentVector.fromArray(["\uFDD0:queues",priority], true),(function (p1__10562_SHARP_){
return cljs.core.vec.call(null,cljs.core.rest.call(null,p1__10562_SHARP_));
}));
});
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__9663__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__9668__auto__,k__9669__auto__){
var self__ = this;
return this__9668__auto__.cljs$core$ILookup$_lookup$arity$3(this__9668__auto__,k__9669__auto__,null);
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__9670__auto__,k10564,else__9671__auto__){
var self__ = this;
if((k10564 === "\uFDD0:state"))
{return self__.state;
} else
{if("\uFDD0:else")
{return cljs.core.get.call(null,self__.__extmap,k10564,else__9671__auto__);
} else
{return null;
}
}
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__9675__auto__,k__9676__auto__,G__10563){
var self__ = this;
var pred__10566 = cljs.core.identical_QMARK_;
var expr__10567 = k__9676__auto__;
if(pred__10566.call(null,"\uFDD0:state",expr__10567))
{return (new io.pedestal.app.queue.AppMessageQueue(G__10563,self__.__meta,self__.__extmap,null));
} else
{return (new io.pedestal.app.queue.AppMessageQueue(self__.state,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__9676__auto__,G__10563),null));
}
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__9682__auto__,writer__9683__auto__,opts__9684__auto__){
var self__ = this;
...
return cljs.core.pr_sequential_writer.call(null,writer__9683__auto__,pr_pair__9685__auto__,"#io.pedestal.app.queue.AppMessageQueue{",", ","}",opts__9684__auto__,cljs.core.concat.call(null,cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null,"\uFDD0:state",self__.state)], true),self__.__extmap));
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__9673__auto__,entry__9674__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__9680__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__9672__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__9664__auto__,other__9665__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__9667__auto__,G__10563){
var self__ = this;
return (new io.pedestal.app.queue.AppMessageQueue(self__.state,G__10563,self__.__extmap,self__.__hash));
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__9666__auto__){
var self__ = this;
return self__.__meta;
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__9677__auto__,k__9678__auto__){
var self__ = this;
if(cljs.core.contains_QMARK_.call(null,cljs.core.PersistentHashSet.fromArray(["\uFDD0:state",null], true),k__9678__auto__))
...
{return (new io.pedestal.app.queue.AppMessageQueue(self__.state,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__9678__auto__)),null));
}
});
io.pedestal.app.queue.AppMessageQueue.cljs$lang$type = true;
io.pedestal.app.queue.AppMessageQueue.cljs$lang$ctorPrSeq = (function (this__9702__auto__){
return cljs.core.list.call(null,"io.pedestal.app.queue/AppMessageQueue");
});
io.pedestal.app.queue.AppMessageQueue.cljs$lang$ctorPrWriter = (function (this__9702__auto__,writer__9703__auto__){
return cljs.core._write.call(null,writer__9703__auto__,"io.pedestal.app.queue/AppMessageQueue");
});
...
io.pedestal.app.queue.map__GT_AppMessageQueue = (function map__GT_AppMessageQueue(G__10565){
return (new io.pedestal.app.queue.AppMessageQueue((new cljs.core.Keyword("\uFDD0:state")).call(null,G__10565),null,cljs.core.dissoc.call(null,G__10565,"\uFDD0:state")));
});
