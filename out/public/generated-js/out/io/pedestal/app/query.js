...
return (function (){var or__3943__auto__ = (io.pedestal.app.query.tuple_seq[goog.typeOf(x__9709__auto__)]);
if(or__3943__auto__)
...
return cljs.core.reduce.call(null,(function (a,p__10537){
var vec__10538 = p__10537;
var c = cljs.core.nth.call(null,vec__10538,0,null);
var t = cljs.core.nth.call(null,vec__10538,1,null);
...
{var iter__9809__auto__ = (function iter__10545(s__10546){
return (new cljs.core.LazySeq(null,false,(function (){
var s__10546__$1 = s__10546;
while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__10546__$1);
if(temp__4092__auto__)
{var xs__4579__auto__ = temp__4092__auto__;
var x = cljs.core.first.call(null,xs__4579__auto__);
var iterys__9805__auto__ = ((function (s__10546__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function iter__10547(s__10548){
return (new cljs.core.LazySeq(null,false,((function (s__10546__$1,x,xs__4579__auto__,temp__4092__auto__){
return (function (){
var s__10548__$1 = s__10548;
while(true){
var temp__4092__auto____$1 = cljs.core.seq.call(null,s__10548__$1);
if(temp__4092__auto____$1)
{var s__10548__$2 = temp__4092__auto____$1;
if(cljs.core.chunked_seq_QMARK_.call(null,s__10548__$2))
{var c__9807__auto__ = cljs.core.chunk_first.call(null,s__10548__$2);
var size__9808__auto__ = cljs.core.count.call(null,c__9807__auto__);
var b__10550 = cljs.core.chunk_buffer.call(null,size__9808__auto__);
if((function (){var i__10549 = 0;
while(true){
if((i__10549 < size__9808__auto__))
{var y = cljs.core._nth.call(null,c__9807__auto__,i__10549);
if(cljs.core._EQ_.call(null,cljs.core.select_keys.call(null,x,ks),cljs.core.select_keys.call(null,y,ks)))
{cljs.core.chunk_append.call(null,b__10550,cljs.core.merge.call(null,x,y));
{
var G__10551 = (i__10549 + 1);
i__10549 = G__10551;
continue;
}
} else
{{
var G__10552 = (i__10549 + 1);
i__10549 = G__10552;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10550),iter__10547.call(null,cljs.core.chunk_rest.call(null,s__10548__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10550),null);
}
} else
{var y = cljs.core.first.call(null,s__10548__$2);
if(cljs.core._EQ_.call(null,cljs.core.select_keys.call(null,x,ks),cljs.core.select_keys.call(null,y,ks)))
{return cljs.core.cons.call(null,cljs.core.merge.call(null,x,y),iter__10547.call(null,cljs.core.rest.call(null,s__10548__$2)));
} else
{{
var G__10553 = cljs.core.rest.call(null,s__10548__$2);
s__10548__$1 = G__10553;
continue;
}
}
}
...
});})(s__10546__$1,x,xs__4579__auto__,temp__4092__auto__))
,null));
});})(s__10546__$1,x,xs__4579__auto__,temp__4092__auto__))
;
var fs__9806__auto__ = cljs.core.seq.call(null,iterys__9805__auto__.call(null,tail));
if(fs__9806__auto__)
{return cljs.core.concat.call(null,fs__9806__auto__,iter__10545.call(null,cljs.core.rest.call(null,s__10546__$1)));
} else
{{
var G__10554 = cljs.core.rest.call(null,s__10546__$1);
s__10546__$1 = G__10554;
continue;
}
}
} else
...
return iter__9809__auto__.call(null,head);
}
});
...
{
var G__10555 = cljs.core.reduce.call(null,((function (unifiers){
return (function (a,b){
...
{if((function (){var G__10557 = data;
if(G__10557)
{if(cljs.core.truth_((function (){var or__3943__auto__ = null;
if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
{return G__10557.io$pedestal$app$query$TupleSource$;
}
})()))
{return true;
} else
{if((!G__10557.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,io.pedestal.app.query.TupleSource,G__10557);
} else
{return false;
}
}
...
var map__10560 = io.pedestal.app.query.parse_query.call(null,query);
...
var in$ = cljs.core.get.call(null,map__10560__$1,"\uFDD0:in");
var find = cljs.core.get.call(null,map__10560__$1,"\uFDD0:find");
var clauses = cljs.core.get.call(null,map__10560__$1,"\uFDD0:clauses");
...
return cljs.core.conj.call(null,a,cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__10558_SHARP_){
return cljs.core.get.call(null,b,p1__10558_SHARP_);
}),find)));
...
q.cljs$lang$applyTo = (function (arglist__10561){
var query = cljs.core.first(arglist__10561);
var sources = cljs.core.rest(arglist__10561);
